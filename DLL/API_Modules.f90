...
MODULE API_DATA
  ...
  TYPE STREET_LINK
    ...
    !INTEGER :: LT_SPEED   !Added Sept17
    !INTEGER :: RT_SPEED   !Added Sept17
  END TYPE
  ...
  TYPE API_ACTUATED_DATA
    ...
    INTEGER :: DETECTOR_LIST(64)
	  ...
	  REAL    :: SPLITS(8)
    !INTEGER :: RED_LOCK_CODE(8)                 !ADDED AUG2016
    !INTEGER :: YELLOW_LOCK_CODE(8)              !ADDED AUG2016
    !INTEGER :: DUAL_ENTRY_CODE(8)               !ADDED AUG2016
    !REAL    :: RED_REVERT_TIME(8)               !ADDED AUG2016
    !INTEGER :: SIMULTANEOUS_GAP_CODE(8)         !ADDED SEPT2016
    !INTEGER :: CONDITIONAL_SERVICE_CODE(8)      !ADDED AUG2016
    !REAL    :: MIN_CONDITIONAL_SERVICE_TIME(8)  !ADDED AUG2016
  END TYPE
  ...
  TYPE STREET_NETWORK_INPUTS
    ...
    INTEGER :: LT_SPEED   !Removed Sept17
    INTEGER :: RT_SPEED   !Removed Sept17
  ...
  TYPE VEHICLE_TYPE_DATA
    ...
    REAL    :: PCT_PITT   !ADDED 4-16-16
    REAL    :: PCT_IDM    !ADDED 4-16-16
    REAL    :: PCT_ACC    !ADDED 4-16-16
    REAL    :: PCT_CACC   !ADDED 5-26-16
  END TYPE
